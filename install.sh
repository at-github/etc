#!/usr/bin/env bash
platform=$(uname);
declare -a files=('.zshrc' '.bash_aliases' '.bash_aliases_mac' '.bash_mancolor' '.bash_profile' '.bash_prompt' '.bashrc' '.dircolors' '.gitconfig' '.gitignore' '.tmux.conf' '.i3/config' '.i3status.conf');
